...
export default function Task({ id, text, comleted, list, onRemove, onEdit, onComplete }) {
  ...
  return (
    <div key={id} className="tasks__items-row">
      <div className="checkbox">
        <input onChange={onChangeCheckbox} id={`task-${id}`} type="checkbox" checked={comleted}></input>
